...
const CORS_ORIGINS = (process.env.CORS_ORIGINS || "http://localhost:5173,http://10.177.194.138:5173")
...
const MFLAGS_D_PATH = path.join(__dirname, "../portal_data", "MFLAGS_D");
...
async function readBLIN(filePath) {
  ...
  const content = await fsp.readFile(filePath, "utf8");
  const parts = content.split(":");
  state["branch logged in No"] = parts[1]
  return state;
}
//teller logged in no
async function readTLIN(filePath) {
  ...
  const content = await fsp.readFile(filePath, "utf8");
  const parts = content.split(":");
  state["teller logged in No"] = parts[1]
  return state;
}
...
const FILE_CONFIG = [
  { name: "jobs", path: "../portal_data/gateway.txt_8app.", reader: readJobsState, usesDateSuffix: true },
  { name: "queue", path: "../portal_data/status_queue_8app.txt.", reader: readQueueState, usesDateSuffix: true },
  { name: "trickle", path: "../portal_data/TRICKLEFEED_MASTER.txt_", reader: readTrickleMasterState, usesDateSuffix: true },
  { name: "space", path: "../portal_data/space_8apps.txt.", reader: readSpaceState, usesDateSuffix: true },
  { name: "context", path: "../portal_data/bncr0004_pace_8app.txt.", reader: readSystemContextState, usesDateSuffix: true },
  { name: "system", path: "../portal_data/topstat_8apps.txt.", reader: readSystemUtilizationState, usesDateSuffix: true },
  { name: "resourse", path: "../portal_data/top_8apps.txt_1.", reader: readHighResourseState, usesDateSuffix: true },
 // { name: "MQStatus", path: "data/mq_status.txt", reader: readMQStatus, usesDateSuffix: false },
  { name: "OCRNEFT", path: "../portal_data/ocr_neft_8apps.txt.", reader: readOCRNEFT, usesDateSuffix: true },
  { name: "branchLoggedInNo", path: "../portal_data/trn_stat_m.txt.", reader: readBLIN, usesDateSuffix: true },
  { name: "tellerLoggedInNo", path: "../portal_data/prod_teller_logged.txt.", reader: readTLIN, usesDateSuffix: true },
  //{ name: "branchLoggedIn", path: "../portal_data/branchlist.txt", reader: readBranchLoggedIn, usesDateSuffix: false },
  ...
  { name: "neftIncomingCount", path: "../portal_data/neft_incoming.txt.", reader: readNeftOncomigCount, usesDateSuffix: true },
  ...
  { name: "PrLegend", path: "../portal_data/legends/pr_card.txt", reader: readLegends, usesDateSuffix: false },
  { name: "NrLegend", path: "../portal_data/legends/nr_card.txt", reader: readLegends, usesDateSuffix: false },
  { name: "DrLegend", path: "../portal_data/legends/dr_card.txt", reader: readLegends, usesDateSuffix: false },
  ...
  { name: "rtgsIncomingPend", path: "../portal_data/rtgs_incoming_rbi_12apps.txt.", reader: readRtgs, usesDateSuffix: true },
  { name: "rtgsOutgoingPend", path: "../portal_data/rtgs_outgoing_psg_12apps.txt.", reader: readRtgs, usesDateSuffix: true },
  { name: "miscTxtCount", path: "../portal_data/schl_data.", reader: readJobsState, usesDateSuffix: true },
  { name: "batchUpload", path: "../portal_data/bu_arka.txt.", reader: readBU, usesDateSuffix: true },
  { name: "Mflags_d", path: "../portal_data/MFLAGS_D", reader: readMflags_d, usesDateSuffix: false },
